...
function ContactInformation({ formContactInformation, setContactInformation, activeStep, setActiveStep, steps }: any) {
    ...
    async function submit() {
        ...
        const apiUrl = "http://localhost:8080/CreatContactInformation";
