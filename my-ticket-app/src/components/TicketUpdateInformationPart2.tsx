...
function TicketUpdateInformationPart2({ formTicketInformation, setTicketInformation, activeStep, setActiveStep, steps }: any) {
    const { TicketInformationID, valueEventDate, valueEventTime, valueVenue, valueTicketPrice, valueSales, valueRestrictions, valueTermsConditions } = formTicketInformation
...
} export default TicketUpdateInformationPart2